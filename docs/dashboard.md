...
- [Duo NL](../dashboards/duo-nl.yaml)
- [Duo EN](../dashboards/duo-en.yaml)
- [Single NL](../dashboards/single-nl.yaml)
- [Single EN](../dashboards/single-en.yaml)

Twijfel je nog over importeren, begin dan bij [Dashboard installeren](installation.md).
...
In de Nederlandstalige dashboards staat onder `Sensorconfiguratie` ook een blok voor dynamische koelbronnen. Dat blok gebruikt het optionele Home Assistant package `dynamic-cooling.yaml`.
...
Zie [Dashboard installeren](installation.md#optioneel-dynamische-koelbronnen-via-home-assistant) voor de installatie van het package.
...
- Uitleg van verwarmen en koelen: [Verwarmen en koelen uitgelegd](https://github.com/OpenQuatt/OpenQuatt/blob/main/docs/verwarmen-en-koelen.md)
- Web-app gebruiken: [Web-app gebruiken](https://github.com/OpenQuatt/OpenQuatt/blob/main/docs/web-app.md)
- Problemen oplossen: [Problemen oplossen](https://github.com/OpenQuatt/OpenQuatt/blob/main/docs/problemen-oplossen.md)
- Technische verdieping: [Instellingen en meetwaarden](https://github.com/OpenQuatt/OpenQuatt/blob/main/docs/instellingen-en-meetwaarden.md)
